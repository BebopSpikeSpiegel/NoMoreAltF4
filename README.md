...
This is NoMoreAltF4, a mod for Hitman 3!

## Installation Instructions

1. Download the latest version of [ZHMModSDK](https://github.com/OrfeasZ/ZHMModSDK) and install it.
2. Download the latest version of `NoMoreAltF4` and copy it to the ZHMModSDK `mods` folder (e.g. `C:\Games\HITMAN 3\Retail\mods`).
3. Run the game and once in the main menu, press the `~` key (`^` on QWERTZ layouts) and enable `NoMoreAltF4` from the menu at the top of the screen (you may need to restart your game afterwards).
4. Enjoy!
